...
\familyname{Gao)\\\vspace{3mm}
\LARGE{HomePage: ~ https://eagerming.com}
} % Your last name
...
\cventry{KDD'20\\在投中...}{*\small Item Recommendation on Shared Accounts through User Identification}{}{}{}{\small \kai{\underline{高崇铭}, 王浩, 余俊良, 曹涌, 聂再清, 阴红志}\vspace{1mm}\\
Submitted to ACM SIGKDD Conference on Knowledge Discovery and Data Mining (\textbf{KDD'20})\vspace{1mm}\\
(会议等级: CCF A), 在投中。\vspace{1mm}\\
内容简介: 天猫精灵作为一款语音助手，其推荐系统不考虑多用户共享使用同一设备的场景。本工作首先通过点播内容将使用同一设备的多个用户区分开，再针对识别出用户进行针对性推荐。其识别效果与推荐效果都超过SOTA算法。
}

\cventry{IS'20\\在投中...\\(Minor Revision)}{\small Semantic Trajectory Representation and Retrieval via Hierarchical Embedding}{}{}{}{\small \kai{\underline{高崇铭}, 张众, 黄晨, 杨勤丽, 邵俊明}\vspace{1mm}\\
Submitted to Information Sciences, (小修)。 \vspace{1mm}\\
(中科院SCI期刊分区 大类: 1区, 小类: 1区, H Index: 154), 在审中。\vspace{1mm}\\
...
\cventry{DASFAA'19}{\small \mbox{*BLOMA: Explain Collaborative Filtering via Boosted Local Rank-One Matrix Approximation}}{}{}{}{\small \kai{\underline{高崇铭}, 袁帅, 张众, 阴红志, 邵俊明}\vspace{1mm}\\
 International Conference on Database Systems for Advanced Applications (\textbf{DASFAA'19}), \vspace{1mm}\\
 (会议等级: CCF B)\vspace{1mm}\\
...
(中科院SCI期刊分区 大类: 1区, 小类: 1区, H Index: 94)\vspace{1mm}\\
...
\cventry{DASFAA'19}{\small SemiSync: Semi-supervised Clustering by Synchronization}{}{}{}{\small \kai{张众, 康迪迪, \underline{高崇铭}, 邵俊明}\vspace{1mm}\\
 International Conference on Database Systems for Advanced Applications (\textbf{DASFAA'19}), \vspace{1mm}\\
(会议等级 CCF B)\vspace{1mm}\\
